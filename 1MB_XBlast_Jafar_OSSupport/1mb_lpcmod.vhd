...
--**+ constants +***
    ...
    constant c_DEV_ID_LOW_NIBBLE: std_logic_vector := "0011";  -- Xblast Jafar (the '3' in 0x13)
    constant c_DEV_ID_HIGH_NIBBLE: std_logic_vector := "0001"; -- XBlast Jafar (the '1' in 0x13)
